...
export default function Dashboard({ month, upcomingBills, dueCounts, incomeVsExpense, expenseByCategory, budgets, recentTransactions }) {
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    <motion.div {...fade(1)} className="card p-6 lg:col-span-2">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <Link href="/bills" className="btn-secondary !py-2">
                                Manage bills
                            </Link>
                        </div>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    <motion.div {...fade(5)} className="card p-6">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <Link href="/budgets" className="text-xs font-semibold text-violet-400 hover:text-violet-300">
                                View all
                            </Link>
                        </div>
