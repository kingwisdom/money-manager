...
export default function Expenses({ expenses, month, total, filter }) {
    const { categories, currency } = usePage().props;
    const [formOpen, setFormOpen] = useState(false);
    const [editing, setEditing] = useState(null);
    const [categoryFilter, setCategoryFilter] = useState(filter === 'all' ? '' : (filter ?? ''));

    const changeFilter = (value) => {
        setCategoryFilter(value);
        router.get('/expenses', { month, category: value }, { preserveState: true, replace: true });
    };
            ...
            <PageHeader
                ...
                actions={
                    <>
                        ...
                        <MonthPicker month={month} route="/expenses" />
